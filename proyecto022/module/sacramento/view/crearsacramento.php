        ...
        <header>
            ...
            <nav class=" container">
                <ol class="breadcrumb " >
                    ...
                    <li class="breadcrumb-item active"> Crear Sacramento</li>
                </ol>
            </nav>
        </header>
                ...
                <div class="jumbotron">
                    <div class="card card-outline-secondary">
                        <div class="card-header">
                            <h3 class="mb-0">Crear Sacramento</h3>
                        </div>
                        <?php
                        ...
                        <div class="card-body">
                            <div class="alert alert-info p-2 pb-3">
                                ...
                                Diligencia este formulario para crear un sacramento
                            </div>

                            <form id="myform" name="myform" method="post" action="../controller/sacramentopostcontroller.php">
